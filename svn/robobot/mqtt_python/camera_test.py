...
FAST_APPROACH = 0.22     # Fast speed to reach the 15cm mark
SLOW_APPROACH = 0.10     # Precision speed for the final 5cm
...
def loop():
    print("% mission-hunt: Starting specialized search...")
    state = "SEARCHING"
